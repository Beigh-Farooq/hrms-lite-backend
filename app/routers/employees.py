...
# Add Employee API (POST /employees)
# Validates input
# Prevents duplicate employee_id or email
...
# List Employees API (GET /employees)
...
# Delete Employee API (DELETE /employees/{employee_id})
